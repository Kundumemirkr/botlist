...
exports.run = function(client, message, args) {
  ...
  .setColor("BLUE")
  .setDescription(`[8 Perm Ekle](https://discordapp.com/oauth2/authorize?client_id=${botid}&scope=bot&permissions=8)`, true)
  .setDescription(`[0 Perm Ekle](https://discordapp.com/oauth2/authorize?client_id=${botid}&scope=bot&permissions=0)`, true)
